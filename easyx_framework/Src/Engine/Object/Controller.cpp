...
Controller::Controller()
{
	...
	inputcomponent = std::shared_ptr<InputComponent>(ConstructComponent<InputComponent>());
}

void Controller::SetupInputComponent(std::shared_ptr<InputComponent> inputcomponent)
{
}
...
///实现相机可活动框限制
void Controller::On_Update(float deltaTime)
{
...
{
	if (!inputcomponent)return; inputcomponent->MouseTick();
}
