...
{
    double newvalue= ((std::max)(newlower, newupper) - (std::min)(newlower, newupper))*((value-(std::min)(oldlower, oldupper)) /((std::max)(oldlower, oldupper) - (std::min)(oldlower, oldupper)))+ (std::min)(newlower, newupper);
    return newvalue;
}
