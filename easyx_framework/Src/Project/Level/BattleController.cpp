...
void BattleController::On_Update(float deltaTime)
{
...
void BattleController::SetupInputComponent(std::shared_ptr<InputComponent> inputcomponent)
{
...
BattleController::BattleController()
{
	...
	/*SignalSlotSystem::CONNECT(this, &BattleController::PlantSeed, this, ProduceSunshine());*/
}
...
void BattleController::PlantSeed()
{
	if (seedToPlant)
	{
		...
		seedToPlant = nullptr;
		SignalSlotSystem::emitSignal(this, &BattleController::PlantSeed);
	}
}
