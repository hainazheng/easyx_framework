...
void Menu::BeginPlay()
{
	...
	enterBattle.Bind(10, [this]() {/*LevelManager::instance()->AddLevel<Menu>("mainMenu");*/ LevelManager::instance()->SetDefaultLevel("DayLawn"); });

}

void Menu::On_Update(float deltaTime)
{
